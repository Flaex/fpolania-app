---
name: Founder-Visionary Branding (2026)
colors:
  surface: '#141313'
  surface-dim: '#141313'
...
- **Color Palette (Tailwind Config):**
  - `white`: `#FFFFFF` (Primary Highlights/Text)
  - `carbon`: `#121313` (Primary Surface/Background)
  - `silver`: `#C0C0C0` (Accents/Icons)
  - `dim-grey`: `#666666` (Subtle UI elements)
  - `slate`: `#282A2A` (Secondary Containers/Neutral)
- **Typography:**
  - **Headings:** `Fraunces` (Bold/Black) — Signals "Editorial Authority" and "Sovereign/Ruler" archetype.
  - **Body/Technical:** `Geist` — Signals "Technical Precision" and "Magician" archetype, reflecting modern craftsmanship.
- **Design Philosophy:** Integrated Visual Communication and Web Programming. Use of a dark-mode, monochromatic high-contrast aesthetic. Ensure "Tailwind-native" execution (no arbitrary values; use config-driven theme).
