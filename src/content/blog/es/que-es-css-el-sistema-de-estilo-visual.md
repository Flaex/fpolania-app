...
> 
*El artículo [¿Qué es HTML? Estructuta de un elemento](/blog/que-es-html-estructura-de-un-elemento/), te podría interesar*
...
* 
En estilos *inline* dentro del atributo style del elemento HTML:
